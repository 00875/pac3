...
function PART:UpdateMaterial(now)
	...
	pac.UpdateMaterialParts("update", self:GetPlayerOwner():DLibUniqueID(), self, self.Materialm)
end

function PART:OnRemove()
	if self:GetPlayerOwner():IsValid() then
		pac.UpdateMaterialParts("remove", self:GetPlayerOwner():DLibUniqueID(), self, self.Materialm)
	end
end
...
function PART:OnShow()
	...
	pac.UpdateMaterialParts("show", self:GetPlayerOwner():DLibUniqueID(), self, self.Name)
end
